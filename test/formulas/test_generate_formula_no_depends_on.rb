...
class TestGenerateFormulaNoDependsOn < Formula
  ...
  homepage "https://github.com/m-dzianishchyts/test-generate-formula-no-depends-on"
  url "https://github.com/m-dzianishchyts/test-generate-formula-no-depends-on/archive/refs/tags/v0.1.0.tar.gz"
