...
class TestGenerateFormulaNoTest < Formula
  ...
  homepage "https://github.com/m-dzianishchyts/test-generate-formula-no-test"
  url "https://github.com/m-dzianishchyts/test-generate-formula-no-test/archive/refs/tags/v0.1.0.tar.gz"
