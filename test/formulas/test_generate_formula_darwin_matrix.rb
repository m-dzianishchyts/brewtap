...
class TestGenerateFormulaDarwinMatrix < Formula
  ...
  homepage "https://github.com/m-dzianishchyts/test-generate-formula-darwin-matrix"
  url "https://github.com/m-dzianishchyts/test-generate-formula-darwin-matrix/archive/refs/tags/v0.1.0.tar.gz"
