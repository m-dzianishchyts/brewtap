...
class TestGenerateFormulaFormulaIncludes < Formula
  ...
  homepage "https://github.com/m-dzianishchyts/test-generate-formula-formula-includes"
  url "https://github.com/m-dzianishchyts/test-generate-formula-formula-includes/archive/refs/tags/v0.1.0.tar.gz"
