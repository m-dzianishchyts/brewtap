...
class TestGenerateFormulaStringFalseConfigs < Formula
  ...
  homepage "https://github.com/m-dzianishchyts/test-generate-formula-string-false-configs"
  url "https://github.com/m-dzianishchyts/test-generate-formula-string-false-configs/archive/refs/tags/v0.1.0.tar.gz"
