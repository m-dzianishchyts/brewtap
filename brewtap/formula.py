...
class Formula:
    ...
    def generate_formula_data(
        ...
        install_instructions = Formula.prepare_instructions(install)
        install_block = {'instructions': install_instructions} if install_instructions else None
        test_instructions = Formula.prepare_instructions(test)
        test_block = {'instructions': test_instructions} if test_instructions else None
...
"""
    ...
    @staticmethod
    def prepare_instructions(input_str: Optional[str]):
